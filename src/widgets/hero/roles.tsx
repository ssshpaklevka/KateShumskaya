...
const Roles: FC = () => {
  return (
    <div className="flex flex-col max-h-none md:max-h-[60px] max-w-none md:max-w-[170px] flex-wrap gap-[16px] md:gap-[14px] lg:max-w-[142px] lg:max-h-full xl:gap-[23px] xl:max-w-[290px] xl:max-h-[120px] top-[21vh] md:top-[58px] lg:top-[25vh] xl:top-[35px] absolute">
