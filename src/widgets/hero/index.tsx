...
const Hero: FC = () => {
  ...
  return (
    <div className={`h-[${fixedHeight}]`}>
      ...
      <div className="bottom-[20px] left-0 absolute w-full px-[20px] md:h-[68vh] md:justify-between md:flex md:flex-col lg:block lg:h-auto xl:flex xl:justify-between xl:w-full xl:h-[65vh]">
        <Heading />
        <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full lg:block xl:flex">
          <Stats />
          <ContactManager />
        </div>
      </div>
